...
class Controller:
    ...
    def th_des(self):
        ...
        array2Vector3(sv, self.data_out.sp)
        array2Vector3(self.M, self.data_out.Kp_hat)
        array2Vector3(errPos, self.data_out.position_error)
        array2Vector3(errVel, self.data_out.velocity_error)
        array2Vector3(delTau, self.data_out.delTau_p)
        array2Vector3(Rho, self.data_out.rho_p)
